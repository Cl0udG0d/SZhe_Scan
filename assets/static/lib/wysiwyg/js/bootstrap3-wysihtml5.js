    ...
    var tpl = {
        ...
        "lists": function(locale, options) {
            ...
            return "<li>" +
                ...
                "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='insertOrderedList' title='" + locale.lists.ordered + "' tabindex='-1'><i class='fa fa-list-ul'></i></a>" +
        ...
        "link": function(locale, options) {
            ...
            return "<li>" +
                ...
                "<label class='checkbox' style='text-align:left;'> <input type='checkbox' class='bootstrap-wysihtml5-insert-link-target' checked>" + locale.link.target + "</label>" +
                "</div>" +
                ...
                "</div>" +
                "</div>" +
                "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='createLink' title='" + locale.link.insert + "' tabindex='-1'><i class='fa fa-share-square-o'></i></a>" +
                "</li>";
        },
