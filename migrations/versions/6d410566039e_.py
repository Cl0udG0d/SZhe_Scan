...
Revision ID: 6d410566039e
Revises: d185164b208e
Create Date: 2022-02-18 18:16:20.421055
...
revision = '6d410566039e'
down_revision = 'd185164b208e'
branch_labels = None
depends_on = None
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('task', sa.Column('key', mysql.VARCHAR(length=24), nullable=False))
    op.create_table('scantask',
