...
Revision ID: 69d3238f97e0
Revises: 978a9235d444
Create Date: 2022-02-18 22:49:29.515360
...
revision = '69d3238f97e0'
down_revision = '978a9235d444'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('baseinfo', sa.Column('tid', sa.String(length=128), nullable=False))
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('baseinfo', 'tid')
    op.create_table('vullist',
